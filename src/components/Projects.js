                  ...
                  <Tab.Container id="projects-tabs" defaultActiveKey="first">
                    ...
                    <Tab.Content id="slideInUp" className={isVisible ? "animate__animated animate__slideInUp" : ""}>
                      ...
                      <Tab.Pane eventKey="second">
                        <p>
                          Ant-Crusher:<br/>
                          An immersive, interactive game designed to entertain users by simulating a virtual ant-squashing experience. This engaging application showcases a vibrant user interface created using React.js and leverages Redux for state management. Constructed with game logic intricacies such as ant animations, scoring mechanisms, and timer functionalities, Ant-Crusher maximizes user engagement and provides an enjoyable and competitive gaming experience.<br></br>

                           Flags of the World:<br/>
                           An educational web app offering an exploration of global flags. Built using React.js and Axios to fetch and display data from a RESTful API, this application provides an interactive platform for users to learn and discover flags from diverse cultures. The design emphasizes adaptable components and effective state management via React hooks, ensuring an engaging and informative experience.<br></br>
